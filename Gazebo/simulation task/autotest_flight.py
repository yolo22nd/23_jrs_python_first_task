...
print('Use set_velocity to fly forward 12 m speed 3 [enter]')
navigate_wait(x=5, frame_id='body', auto_arm=True)
...
print('Use set_velocity to fly forward 6 m speed 1 [enter]')
...
print('Use set_velocity to fly forward 4 m speed 1 [enter]')
set_velocity(vx=1, vy=0.0, vz=0, frame_id='body')
rospy.sleep(4)
set_velocity(vx=0, vy=0.0, vz=0, frame_id='body')

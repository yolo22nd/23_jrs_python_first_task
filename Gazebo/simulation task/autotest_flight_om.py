...
input('Take off and hover 2 m [enter] ')
...
input('Use set_velocity to fly forward 12 m speed 3 [enter] ')
navigate_wait(x=5, frame_id='map')
set_velocity(vx=3, vy=0.0, vz=0, frame_id='body')
rospy.sleep(2)
set_velocity(vx=0, vy=0.0, vz=0, frame_id='body')
# set_position(frame_id='body')


input('Hover 2 m [enter] ')
navigate_wait(x=0, y=0, z=2, frame_id='map')
print_distance()
start = get_telemetry()

input('Rotate90 [enter] ')
navigate(yaw=-math.pi / 2, frame_id='navigate_target')
rospy.sleep(2)

input('Use set_velocity to fly forward 5 m speed 1 [enter] ')
...
input('Rotate 180 [enter] ')
navigate(yaw=math.pi, frame_id='navigate_target')
rospy.sleep(2)

input('Use set_velocity to fly forward 4 m speed 1 [enter]')
set_velocity(vx=1, vy=0.0, vz=0, frame_id='body')
rospy.sleep(4)
set_velocity(vx=0, vy=0.0, vz=0, frame_id='body')
